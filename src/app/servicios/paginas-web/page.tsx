...
export const metadata: Metadata = {
  title: 'Páginas Web | Buenas Web',
  description: 'Creamos páginas web modernas, funcionales y optimizadas para tu negocio.',
  keywords: ['páginas web', 'diseño web', 'desarrollo web', 'SEO', 'sitios web modernos'],
  openGraph: {
    title: 'Páginas Web | Buenas Web',
    description: 'Diseñamos y desarrollamos páginas web que destacan por su funcionalidad y estética.',
    url: 'https://www.buenasweb.com/servicios/paginas-web',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'Diseño de Páginas Web - Buenas Web',
      },
    ],
  },
  twitter: {
    ...
    title: 'Páginas Web | Buenas Web',
    description: 'Expertos en diseño y desarrollo de páginas web modernas.',
    images: ['/og-image.jpg'],
  },
};
